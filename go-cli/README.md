...
AQL-driven CLI and REPL for the SouthParkQuotes SDK. Positional arguments are
...
```sh
go build -o south-park-quotes-cli ./...
```
...
./south-park-quotes-cli load 1 quote
./south-park-quotes-cli load '{id:1}' quote
