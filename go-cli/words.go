...
func registerSDKWords(r *eng.Registry, client *sdk.SouthParkQuotesSDK) {
...
func runOp(client *sdk.SouthParkQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
