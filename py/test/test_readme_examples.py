# SouthParkQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SouthParkQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SouthParkQuotesSDK(...) and SouthParkQuotesSDK.test(...) become
#      SouthParkQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "southparkquotes_sdk"
_SDK_CLASS = "SouthParkQuotesSDK"
