...
from southparkquotes_sdk.core.control import SouthParkQuotesControl
...
from southparkquotes_sdk.core.helpers import get_ctx_prop, to_map
...
class SouthParkQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SouthParkQuotesControl()
        ...
        if isinstance(sp, SouthParkQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SouthParkQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SouthParkQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SouthParkQuotesOperation({})
    ...
    def make_error(self, code, msg):
        return SouthParkQuotesError(code, msg, self)
