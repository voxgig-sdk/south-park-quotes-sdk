...
from southparkquotes_sdk.utility import register

# Load features
from southparkquotes_sdk.feature.base_feature import SouthParkQuotesBaseFeature
from southparkquotes_sdk.features import _has_feature, _make_feature
...
class SouthParkQuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SouthParkQuotesUtility()
        self._utility = utility

        from southparkquotes_sdk.config import shared_config
    ...
    def get_utility(self):
        return SouthParkQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SouthParkQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Quote(self, data=None) -> "QuoteEntity":
        ...
        from southparkquotes_sdk.entity.quote_entity import QuoteEntity
