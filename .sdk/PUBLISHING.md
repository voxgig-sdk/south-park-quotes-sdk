...
|---|---|---|
| `ts/` | @voxgig-sdk/south-park-quotes-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/south-park-quotes-sdk \
      --repository voxgig-sdk/south-park-quotes-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/south-park-quotes-sdk` shows it, and
`npm trust revoke @voxgig-sdk/south-park-quotes-sdk --id=<id>` removes it.
