...
// SouthParkQuotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SouthParkQuotesMakeRequest
{
    public static function call(SouthParkQuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SouthParkQuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SouthParkQuotesResponse($fetched);
        } else {
