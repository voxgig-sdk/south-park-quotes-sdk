...
// SouthParkQuotes SDK pipeline test
//
...
{
    private static function utility(): SouthParkQuotesUtility
    {
        return new SouthParkQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): SouthParkQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SouthParkQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SouthParkQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SouthParkQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SouthParkQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SouthParkQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SouthParkQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SouthParkQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SouthParkQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SouthParkQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SouthParkQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SouthParkQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SouthParkQuotesResponse([]),
            'result' => new SouthParkQuotesResult([]),
        ]);
        [, $err] = SouthParkQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec([]),
            'response' => null,
            'result' => new SouthParkQuotesResult([]),
        ]);
        [, $err] = SouthParkQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec(['step' => 's']),
            'response' => new SouthParkQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SouthParkQuotesResult([]),
        ]);
        [, $err] = SouthParkQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec(['step' => 's']),
            'response' => new SouthParkQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new SouthParkQuotesResult([]),
        ]);
        [, $err] = SouthParkQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec(['step' => 's']),
            'response' => new SouthParkQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new SouthParkQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SouthParkQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new SouthParkQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec([]),
            'response' => new SouthParkQuotesResponse([]),
            'result' => new SouthParkQuotesResult([]),
        ...
        [$got, $err] = SouthParkQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SouthParkQuotesResult([])]);
        [, $err] = SouthParkQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SouthParkQuotesSpec([]), 'result' => null]);
        [, $err] = SouthParkQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SouthParkQuotesSpec(['step' => 's']),
            'result' => new SouthParkQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SouthParkQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SouthParkQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SouthParkQuotesSpec(['step' => 's']),
            'result' => new SouthParkQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SouthParkQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SouthParkQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SouthParkQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SouthParkQuotesSpec([]),
            'result' => new SouthParkQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SouthParkQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SouthParkQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SouthParkQuotesError('boom', 'boom');
        $utility->fetcher = function (SouthParkQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SouthParkQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SouthParkQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SouthParkQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SouthParkQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SouthParkQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SouthParkQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SouthParkQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SouthParkQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SouthParkQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SouthParkQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SouthParkQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SouthParkQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SouthParkQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SouthParkQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SouthParkQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SouthParkQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SouthParkQuotesResult(['ok' => false])]);
        $this->expectException(SouthParkQuotesError::class);
        SouthParkQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SouthParkQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SouthParkQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SouthParkQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SouthParkQuotesBaseFeature();
        $b = new SouthParkQuotesBaseFeature();
        SouthParkQuotesFeatureAdd::call($ctx, $a);
        SouthParkQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SouthParkQuotesBaseFeature
    {
        $f = new SouthParkQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SouthParkQuotesFeatureAdd::call($ctx, self::named_feature('a'));
        SouthParkQuotesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        SouthParkQuotesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        SouthParkQuotesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        SouthParkQuotesFeatureAdd::call($ctx, $replace);
        ...
        SouthParkQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SouthParkQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SouthParkQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SouthParkQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SouthParkQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SouthParkQuotesResponse(['headers' => null]),
            'result' => new SouthParkQuotesResult([]),
        ]);
        SouthParkQuotesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SouthParkQuotesResultBody::call($ctx);
