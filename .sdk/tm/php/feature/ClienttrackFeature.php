...
// SouthParkQuotes SDK clienttrack feature
...
class SouthParkQuotesClienttrackFeature extends SouthParkQuotesBaseFeature
{
    ...
    public function PostConstruct(SouthParkQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SouthParkQuotes-SDK';
