...
// SouthParkQuotes SDK cache feature
...
class SouthParkQuotesCacheFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _through(SouthParkQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
