...
// SouthParkQuotes SDK rbac feature
...
class SouthParkQuotesRbacFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _required(SouthParkQuotesContext $ctx): ?string
    {
    ...
    private function _reject(SouthParkQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(SouthParkQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
