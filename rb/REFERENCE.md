# SouthParkQuotes Ruby SDK Reference

Complete API reference for the SouthParkQuotes Ruby SDK.
...
```ruby
require_relative 'south-park-quotes_sdk'
...
#### `SouthParkQuotesSDK.test(testopts = nil, sdkopts = nil)`
