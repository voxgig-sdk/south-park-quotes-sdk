...
#      offline in seeded test mode (SouthParkQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SouthParkQuotes_sdk.rb")
  SDK_CLASS = "SouthParkQuotesSDK"
