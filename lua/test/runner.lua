...
function runner.env_override(m)
  local live = runner.getenv("SOUTHPARKQUOTES_TEST_LIVE")
  local override = runner.getenv("SOUTHPARKQUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SOUTHPARKQUOTES_TEST_EXPLAIN")
