...
function runner.env_override(m)
  local live = runner.getenv("SOUTH_PARK_QUOTES_TEST_LIVE")
  local override = runner.getenv("SOUTH_PARK_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SOUTH_PARK_QUOTES_TEST_EXPLAIN")
