# SouthParkQuotes Lua SDK



The Lua SDK for the SouthParkQuotes API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/south-park-quotes-sdk/releases)),
...
```
lua/
├── south-park-quotes_sdk.lua    -- Main SDK module
...
The main module (`south-park-quotes_sdk`) exports the SDK constructor
