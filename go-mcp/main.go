// Command SouthParkQuotes-mcp is an MCP server exposing the SouthParkQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SouthParkQuotes_list  — list records of an entity
//	SouthParkQuotes_load  — load a single record of an entity
//
