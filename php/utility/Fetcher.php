...
// SouthParkQuotes SDK utility: fetcher

class SouthParkQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SouthParkQuotesSDK/1.0)';
    ...
    public static function call(SouthParkQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
