...
// SouthParkQuotes SDK utility: graphql
//
...
class SouthParkQuotesGraphql
{
    ...
    // equivalent.
    public static function body(SouthParkQuotesContext $ctx): mixed
    {
    ...
    public static function errors(SouthParkQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
