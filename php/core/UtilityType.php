...
// SouthParkQuotes SDK utility type

class SouthParkQuotesUtility
{
    ...
    public static function copy(SouthParkQuotesUtility $src): SouthParkQuotesUtility
    {
        $u = new SouthParkQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
