...
// SouthParkQuotes SDK idempotency feature
...
class SouthParkQuotesIdempotencyFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _mutating(SouthParkQuotesContext $ctx): bool
    {
