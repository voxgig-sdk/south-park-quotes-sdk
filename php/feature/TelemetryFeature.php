...
// SouthParkQuotes SDK telemetry feature
...
class SouthParkQuotesTelemetryFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _close(SouthParkQuotesContext $ctx, bool $ok): void
    {
