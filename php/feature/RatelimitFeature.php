...
// SouthParkQuotes SDK ratelimit feature
...
class SouthParkQuotesRatelimitFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _acquire(SouthParkQuotesContext $ctx): void
    {
    ...
    private function _track(SouthParkQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
