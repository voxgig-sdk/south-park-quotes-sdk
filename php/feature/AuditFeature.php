...
// SouthParkQuotes SDK audit feature
...
class SouthParkQuotesAuditFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _emit(SouthParkQuotesContext $ctx, string $outcome): void
    {
