...
// SouthParkQuotes SDK proxy feature
...
class SouthParkQuotesProxyFeature extends SouthParkQuotesBaseFeature
{
    ...
    public function init(SouthParkQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SouthParkQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
