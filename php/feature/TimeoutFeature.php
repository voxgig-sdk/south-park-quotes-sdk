...
// SouthParkQuotes SDK timeout feature
...
class SouthParkQuotesTimeoutFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _with_timeout(SouthParkQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SouthParkQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
