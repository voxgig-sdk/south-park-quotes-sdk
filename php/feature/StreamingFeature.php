...
// SouthParkQuotes SDK streaming feature
...
class SouthParkQuotesStreamingFeature extends SouthParkQuotesBaseFeature
{
    ...
    private function _iterate(SouthParkQuotesResult $result): \Generator
    {
    ...
    private function _streamable(SouthParkQuotesContext $ctx): bool
    {
