...
// SouthParkQuotes SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SouthParkQuotesOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SouthParkQuotesOmni::structfix($now, Struct::undef()))
                        !== json_encode(SouthParkQuotesOmni::structfix($val, Struct::undef()))) {
