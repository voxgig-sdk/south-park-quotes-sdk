...
// SouthParkQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SouthParkQuotesSDK::test)
...
{
    private const SDK_CLASS = 'SouthParkQuotesSDK';
    ...
    private const SDK_BASE = 'southparkquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../southparkquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
