# SouthParkQuotes PHP SDK Reference

Complete API reference for the SouthParkQuotes PHP SDK.
...
```php
require_once __DIR__ . '/south-park-quotes_sdk.php';
...
#### `SouthParkQuotesSDK::test($testopts = null, $sdkopts = null)`
