...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SOUTHPARKQUOTES_TEST_LIVE ||
    'TRUE' === process.env.SOUTHPARKQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.SOUTHPARKQUOTES_TEST_EXPLAIN = process.env.SOUTHPARKQUOTES_TEST_EXPLAIN || m.SOUTHPARKQUOTES_TEST_EXPLAIN
