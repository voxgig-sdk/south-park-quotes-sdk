...
The TypeScript SDK for the SouthParkQuotes API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new SouthParkQuotesSDK({ apikey: '...' })
