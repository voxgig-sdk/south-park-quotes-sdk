# SouthParkQuotes TypeScript SDK



The TypeScript SDK for the SouthParkQuotes API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/south-park-quotes-sdk/releases](https://github.com/voxgig-sdk/south-park-quotes-sdk/releases)
...
```ts
new SouthParkQuotesSDK(options?: {
  base?: string
  prefix?: string
  suffix?: string
...
| `tester(testopts?, sdkopts?)` | `SouthParkQuotesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `SouthParkQuotesSDK.test(testopts?, sdkopts?)` | `SouthParkQuotesSDK` | Create a test-mode client. |
...
south-park-quotes/
├── src/
│   ├── SouthParkQuotesSDK.ts        # Main SDK class
