# SouthParkQuotes TypeScript SDK Reference

Complete API reference for the SouthParkQuotes TypeScript SDK.
...
```ts
new SouthParkQuotesSDK(options?: object)
```
...
#### `SouthParkQuotesSDK.test(testopts?, sdkopts?)`
...
**Returns:** `SouthParkQuotesSDK` instance in test mode.
...
Alias for `SouthParkQuotesSDK.test()`.
...
Return the parent `SouthParkQuotesSDK` instance.
