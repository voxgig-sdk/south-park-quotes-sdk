...
(0, node_test_1.describe)('QuoteDirect', async () => {
    ...
    // `test.live.delayMs`; only sleeps when SOUTH_PARK_QUOTES_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('SOUTH_PARK_QUOTES_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SouthParkQuotesSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SouthParkQuotesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['SOUTH_PARK_QUOTES_TEST_QUOTE_ENTID'];
    ...
    const client = new __1.SouthParkQuotesSDK({
        base: 'http://localhost:8080',
