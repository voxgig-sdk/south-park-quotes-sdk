...
function envOverride(m) {
    if ('TRUE' === process.env.SOUTH_PARK_QUOTES_TEST_LIVE ||
        'TRUE' === process.env.SOUTH_PARK_QUOTES_TEST_OVERRIDE) {
    ...
    m.SOUTH_PARK_QUOTES_TEST_EXPLAIN = process.env.SOUTH_PARK_QUOTES_TEST_EXPLAIN || m.SOUTH_PARK_QUOTES_TEST_EXPLAIN;
    return m;
}
