# SouthParkQuotes Golang SDK Reference

Complete API reference for the SouthParkQuotes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *SouthParkQuotesSDK`
...
#### `Quote(data map[string]any) SouthParkQuotesEntity`
